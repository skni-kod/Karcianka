        ...
        <transition name="form">
          <div class="loginBox" v-if="!registerFormActive">
            <form class="loginForm" @submit.prevent="loginUser">
              ...
              <button v-if="!logging" class="loginButton">Zaloguj się</button>
              <button v-else class="loginButton">Logowanie ...</button>
            </form>
            <p class="text">lub</p>
            <p class="toRegisterButton" @click="registerFormActive = true">
              Załóż konto
            </p>
          </div>
        </transition>
        <transition name="form">
          <div class="registerBox" v-if="registerFormActive">
            <form class="registerForm" @submit.prevent="registerUser">
              ...
              <label
                >Akcpetuję warunki korzystania z serwisu i politykę
                prywatności</label
              >
              <button v-if="sending" class="registerButton">
                Rejestrowanie...
              </button>
              <button v-else class="registerButton">Załóż konto</button>
            </form>
            <p class="text">lub</p>
            <p class="toRegisterButton" @click="registerFormActive = false">
              Zaloguj się
            </p>
          </div>
        </transition>
      </div>
      <div class="closePopup" @click="$store.dispatch('closePlayPopup')"></div>
    </div>
  </transition>
</template>
    ...
    .nickname {
      ...
      &:focus {
        ...
        text-shadow: 1px 0px 4px var(--blue), 2px 0px 4px var(--blue),
          ...
          2px 0px 20px var(--blue), 5px 0px 125px var(--blue), 20px 0vw 200px;
