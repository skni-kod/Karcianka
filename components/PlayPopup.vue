    ...
    <transition name="popup">
        <div class="playPopup" v-if="open" onselectstart="return false;">
            <div class="gameSection">
                <input type="text" class="nickname" name="nickname" maxlength="20" placeholder="Podaj nickname"/>
                ...
                <transition name="form">
                    <div class="loginBox" v-if="!registerFormActive">
                        <form class="loginForm">
                            ...
                            <button class="loginButton" @click="loginUser">Zaloguj się</button>
                        </form>
                        <p class="text">lub</p>
                ...
                <transition name="form">
                    <div class="registerBox" v-if="registerFormActive">
                        <form class="registerForm">
                            ...
                            <fieldset>
                                <input type="password" class="password formInput" name="password" maxlength="30" placeholder="Hasło" required/>
                                <input type="password" class="confirmPassword formInput" name="confirmPassword" maxlength="30" placeholder="Potwierdź hasło" required/>
                            </fieldset>
                            <input type="checkbox" class="terms" name="terms" required />
                            <label>Akcpetuję warunki korzystania z serwisu i politykę prywatności</label>
                            <button class="registerButton" @click="registerUser">Załóż konto</button>
                        </form>
                        <p class="text">lub</p>
                        <p class="toRegisterButton" @click="registerFormActive = false">Zaloguj się</p>
                    </div>
                </transition>
            </div>
